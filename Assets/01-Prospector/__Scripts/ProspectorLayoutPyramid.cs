...
public class ProspectorPyramidSlotDef
{
...
public class ProspectorLayoutPyramid : MonoBehaviour
{
    ...
    public List<ProspectorPyramidSlotDef> prospectorPyramidSlotDefs; // All the SlotDefs for Row0-Row3

    public ProspectorPyramidSlotDef drawPile;

    public ProspectorPyramidSlotDef discardPile;
    ...
    public void ReadLayout(string xmlText)
    {
        ...
        for (int i = 0; i < slotsX.Count; i++)
        {
            ...
            tSD = new ProspectorPyramidSlotDef(); // Create a new SlotDef instance
            ...
            switch (tSD.type)
            {
                ...
                case "slot":
                    ...
                    prospectorPyramidSlotDefs.Add(tSD);
