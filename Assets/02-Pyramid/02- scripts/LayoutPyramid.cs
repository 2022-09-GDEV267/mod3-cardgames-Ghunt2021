...
public class LayoutPyramid : MonoBehaviour
{
    ...
    public List<PyramidSlotDef> pyramidSlotDefs; // All the SlotDefs for Row0-Row3

    public PyramidSlotDef drawPile;
    ...
    public void ReadLayout(string xmlText)
    {
        ...
        for (int i = 0; i < slotsX.Count; i++)
        {
            ...
            tSD = new PyramidSlotDef(); // Create a new SlotDef instance
